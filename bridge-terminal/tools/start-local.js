...
const env = { ...process.env, PORT: port, VWS_HOST: '127.0.0.1', VWS_PRINCIPALS_FILE: pf, VWS_SECURE_COOKIES: '0', VWS_FABRIC: df ? '1' : '0', VWS_SNAPSHOTS: '1', VWS_SNAPSHOT_DIR: path.join(dataDir, 'snapshots') };
