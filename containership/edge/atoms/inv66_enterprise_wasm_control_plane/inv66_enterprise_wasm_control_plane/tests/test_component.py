"""Conformance test for INV-66 (inv66_enterprise_wasm_control_plane) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv66_enterprise_wasm_control_plane/tests/test_component.py
