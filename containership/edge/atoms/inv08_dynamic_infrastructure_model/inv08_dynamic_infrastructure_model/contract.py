...
def build() -> Contract:
    ...
    return Contract(
        ...
        name=ELEMENT_NAME,
        responsibility=(
            "Own elastic capacity: lease-based node membership, demand-driven scaling "
            "within bounds, safe reclamation of idle nodes and cost accounting."
        ),
        owns=[
        ...
        non_goals=["Provisioning hardware", "Scheduling work", "Billing"],
        interfaces={
