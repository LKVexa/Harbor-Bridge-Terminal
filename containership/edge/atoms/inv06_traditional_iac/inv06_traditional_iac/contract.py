...
def build() -> Contract:
    ...
    return Contract(
        ...
        assumptions=[
            ...
            "Reference state and plan payloads are JSON-compatible so they can be hashed and schema-validated deterministically"
        ],
        boundaries={
        ...
        signals={
            ...
            "protected_refusals": "counter",
            "invalid_plan_refusals": "counter",
            "drift_scans": "counter",
            "drifted": "gauge",
