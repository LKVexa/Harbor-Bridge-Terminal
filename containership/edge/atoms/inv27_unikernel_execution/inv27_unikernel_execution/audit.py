"""Tamper-evident audit events for INV-27 (C049).

Each event is a PK_UK_AUDIT_EVENT/1 record whose ``hash`` covers its body and the previous event's
