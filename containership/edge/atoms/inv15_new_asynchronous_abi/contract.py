...
def build() -> Contract:
    ...
    return Contract(
        ...
        owns=[
            "Opaque, instance-scoped subtask handle allocation and lifetime",
        ...
        assumptions=[
            ...
            "A caller that goes away must not leave a subtask or unread result occupying host state forever"
        ],
        boundaries={
        ...
        mandatory=[
            "Return an opaque, instance-scoped subtask handle for every call that does not complete immediately",
        ...
        threats=[
            "Handle collision or forgery letting one instance wait on another's subtask",
            "Unbounded live or historical handle state exhausting host memory",
