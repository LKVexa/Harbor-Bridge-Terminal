"""Conformance test for INV-15 -- stdlib unittest, no network.

The runtime ABI has its own dependency-free suite in ``test_abi.py``. These
checks additionally exercise the pk_core certification integration when that
