"""Conformance test for INV-61 (inv61_distributed_wit_rpc) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv61_distributed_wit_rpc/tests/test_component.py
...
class ConformanceTest(unittest.TestCase):
    def test_version(self):
        ...
        self.assertEqual(_load().__version__, expected)
