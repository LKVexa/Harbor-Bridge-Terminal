...
def build() -> Contract:
    ...
    return Contract(
        ...
        source_of_truth="The pollable's latched readiness state; a poll returns stable ready indexes/names or a bounded timeout, never a guess.",
        assumptions=[
        ...
        mandatory=[
            "Return ready pollable indexes/names or a timeout, never block unbounded",
        ...
        interfaces={
            "poll": "PK_POLL/1 - bounded wait on a finite pollable set; returns ready names and stable indexes",
            "pollable": "PK_POLLABLE/1 - a latched readiness handle owned by one instance",
            "poll_error": "PK_POLL_ERROR/1 - machine-readable validation and boundary refusal details",
