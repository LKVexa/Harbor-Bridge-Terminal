"""Conformance test for INV-14 (inv14_previous_asynchronous_model) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv14_previous_asynchronous_model/tests/test_component.py
