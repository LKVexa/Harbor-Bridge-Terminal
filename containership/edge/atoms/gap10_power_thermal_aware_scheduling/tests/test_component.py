"""Conformance test for GAP-10 (gap10_power_thermal_aware_scheduling) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python gap10_power_thermal_aware_scheduling/tests/test_component.py
