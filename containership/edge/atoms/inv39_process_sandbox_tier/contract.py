...
def build() -> Contract:
    ...
    return Contract(
        ...
        source_of_truth=("Backend/OS evidence of the applied sandbox state, bound to the canonical profile digest; "
                         "requested configuration alone is never accepted as proof of enforcement."),
        assumptions=[
        ...
        mandatory=[
            ...
            "Verify applied state from backend/OS evidence rather than requested configuration",
        ...
        interfaces={
            ...
            "apply": "PK_SANDBOX_APPLIED/2 - signed, kernel-read-back applied state and residual surface (/1 deprecated)",
            "error": "PK_SANDBOX_ERROR/1 - stable error code, outcome class, retryability",
            "status": "PK_SANDBOX_STATUS/1 - health, readiness, version, config digest, active controls"
        },
        threats=[
