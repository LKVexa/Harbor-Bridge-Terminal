"""Conformance test for PLN-03 (pln03_distributed_runtime_plane) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python pln03_distributed_runtime_plane/tests/test_component.py
...
KNOWN_PARTIAL = ["PLN-03-C034", "PLN-03-C046", "PLN-03-C053", "PLN-03-C056"]
