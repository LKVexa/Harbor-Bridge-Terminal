# Runbook: Stale topology (GAP03StaleTopology)
...
1. Compare topology generation vs GAP-02 inventory generation
2. Check topology mutation error codes

## Mitigation / rollback / disable

- Import from authoritative bundle with import_bundle() (digest verified)
- Quarantine nodes via set_lifecycle rather than delete
