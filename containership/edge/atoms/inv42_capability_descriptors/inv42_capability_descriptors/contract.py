...
def build() -> Contract:
    ...
    return Contract(
        ...
        assumptions=[
            ...
            "Serialized descriptors are attacker-controlled input and must be authenticated before resolution",
        ...
        interfaces={
            "open": "PK_DESCRIPTOR/2 - allocate an authenticated typed descriptor in a table",
            "import": "PK_DESCRIPTOR/2 - strictly parse and authenticate a serialized descriptor",
            "resolve": "PK_DESCRIPTOR_RESOLVE/2 - resolve an authenticated descriptor within its own table",
            "close": "PK_DESCRIPTOR_CLOSE/2 - permanently close an authenticated descriptor number",
            "status": "PK_DESCRIPTOR_TABLE_STATUS/1 - expose bounded non-secret table health/counters",
            "destroy": "local lifecycle operation - revoke the table and best-effort zeroize its key"
        },
        threats=[
            "Descriptor number guessing or descriptor forgery reaching another resource",
            ...
            "Fork-cloned descriptor tables issuing divergent authority under one table identity"
        ],
        failure_modes=[
            ...
            "Descriptor table used after process fork",
            "Session allocation space exhausted"
        ],
        slos=[
        ...
        signals={
            ...
            "invalid_descriptors": "counter of malformed or authentication-failed descriptors",
            "capacity_rejections": "counter of live-table or session-allocation limit rejections",
            "fork_rejections": "counter of attempts to use a table from a different process"
        },
    )
