...
def build() -> Contract:
    ...
    return Contract(
        ...
        interfaces={
            ...
            "envelope": "PK_POLICY_SIGNED_BUNDLE/1 - Ed25519-signed envelope verified before parsing",
            "errors": "PK_POLICY_ERROR/1 - stable G13-Exxx codes",
            "health": "PK_POLICY_HEALTH/1 / PK_POLICY_STATUS/1 - readiness, version, age, floor, controls",
            "rpc": "HTTP/JSON /v1 - authenticated, deadline-bounded, backpressured"
        },
        threats=[
        ...
        signals={
            ...
            "stale_refusals": "counter of FAIL_CLOSED refusals past hard expiry",
            "evaluate_latency_ms": "histogram of evaluation latency",
            "overload_shed": "counter of admission-control rejections",
            "auth_denied": "counter of privileged-operation authorization denials"
        },
    )
