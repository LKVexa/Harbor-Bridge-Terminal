...
def build() -> Contract:
    ...
    return Contract(
        ...
        assumptions=[
            ...
            "Canonical payloads are data-only values; executable/custom host objects never cross the boundary",
        ...
        mandatory=[
            ...
            "Transfer ownership explicitly and atomically; never alias mutable state across the boundary",
            "Reject malformed, cyclic, over-deep or non-data canonical payloads",
        ...
        threats=[
            ...
            "Cyclic or adversarial payloads exhausting boundary resources",
            "User-controlled copy hooks executing during canonicalization",
            "Ownership double-free or double-move across the boundary"
        ],
        failure_modes=[
            "Type unrepresentable in the target language",
            "Value out of range for the target representation",
            "Encoding conversion fails",
            "Canonical payload violates shape, depth or size limits",
        ...
        signals={
            ...
            "canonicalization_refusals": "counter by refusal code and canonical type",
            "encoding_refusals": "counter by language and interface"
        },
    )
