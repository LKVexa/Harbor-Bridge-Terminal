...
def build() -> Contract:
    ...
    return Contract(
        ...
        owns=[
            ...
            "Transfer integrity requirement and digest metadata"
        ],
        not_owns=[
            "Storage backends",
        ...
        mandatory=[
            ...
            "Require end-to-end integrity verification for every transfer; the concrete transport supplies and verifies the payload digest"
        ],
        optional=[
