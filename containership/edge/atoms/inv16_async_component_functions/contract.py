...
def build() -> Contract:
    ...
    return Contract(
        ...
        failure_modes=[
            ...
            "Re-entrancy queue full",
            "Late event after terminal history expired",
            "Call-id space exhausted for the current generation"
        ],
        slos=[
        ...
        signals={
            ...
            "concurrency_refusals": "counter of calls refused at the configured in-flight limit",
            "double_delivery": "counter, expected to stay at zero",
            "cancelled_calls": "counter of calls terminated by cancellation",
            "trapped_calls": "counter of calls terminated by callee trap",
            "completed_calls": "counter of calls completed",
            "calls_queued": "gauge of calls waiting in a re-entrancy queue",
            "queue_refusals": "counter of calls refused because the re-entrancy queue was full",
            "tombstones": "gauge of retained terminal records (bounded)",
            "tombstone_evictions": "counter of terminal records reclaimed",
            "expired_late_events": "counter of late events after history expiry",
            "call_ids_remaining": "gauge of unallocated call ids in the generation",
            "bridge_latency_ns": "histogram of sync bridge latency"
        },
    )
