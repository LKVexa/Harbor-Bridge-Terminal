...
def build() -> Contract:
    ...
    return Contract(
        ...
        interfaces={
            "admit": "PK_ADMISSION/1 - request admission for a workload at a trust class; schema schemas/PK_ADMISSION_1.schema.json",
            "catalogue": "PK_TIER_CATALOGUE/1 - attested tiers available on this node; schema schemas/PK_TIER_CATALOGUE_1.schema.json",
            "lifecycle": "PK_TIER_LIFECYCLE/1 - admission/quarantine/teardown lifecycle events; schema schemas/PK_TIER_LIFECYCLE_1.schema.json"
        },
        threats=[
