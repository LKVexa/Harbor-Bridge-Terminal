"""Release provenance producer (MC-39) — adapted from the owner's INV-44 v4.3.0 ``provenance.py``.
...
def statement(subject: list[dict], *, version: str, builder_id: str, invocation: dict,
              dependencies: list[dict], build_type: str = "urn:pk:inv64:local-build:1") -> dict:
    return {
