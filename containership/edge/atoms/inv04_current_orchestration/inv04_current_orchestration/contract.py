...
def build() -> Contract:
    ...
    return Contract(
        ...
        interfaces={
            "reconcile": "PK_ORCH_RECONCILE/1 - desired versus running; schema: schemas/PK_ORCH_RECONCILE_v1.schema.json",
            "drain": "PK_ORCH_DRAIN/1 - a budget-respecting node drain; schema: schemas/PK_ORCH_DRAIN_v1.schema.json",
            "inventory": "PK_ORCH_INVENTORY/1 - workloads for hand-off; schema: schemas/PK_ORCH_INVENTORY_v1.schema.json"
        },
        threats=[
