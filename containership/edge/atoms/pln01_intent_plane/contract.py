...
try:  # pk_core is an optional, pinned integration dependency (see pyproject.toml)
    from pk_core.contract import Contract, Dependency, Slo
    PK_CORE_AVAILABLE = True
except ModuleNotFoundError:
    from .contract_types import Contract, Dependency, Slo
...
def build() -> Contract:
    ...
    return Contract(
        ...
        signals={
            ...
            "pln01_requests_total": "request counter by op and outcome code",
            "pln01_request_seconds": "histogram of request latency by op",
            "pln01_bulkhead_saturation": "fraction of concurrency+queue capacity in use"
        },
    )
