...
def build() -> Contract:
    ...
    return Contract(
        ...
        owns=[
            ...
            "Fail-closed validation of admission inputs",
        ...
        source_of_truth="The versioned baseline in force at admission; malformed inputs fail closed and an exception is valid only until its recorded expiry.",
        assumptions=[
        ...
        mandatory=[
            ...
            "Fail closed on incomplete or malformed security-critical input"
        ],
        optional=[
        ...
        threats=[
            ...
            "Admission bypass through omitted or malformed security fields",
            "Exception tampering or invalid expiry values"
        ],
        failure_modes=[
            "Control failed",
            "Exception expired",
