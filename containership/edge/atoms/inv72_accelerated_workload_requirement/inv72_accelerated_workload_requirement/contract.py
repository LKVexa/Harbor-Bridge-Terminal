...
def build() -> Contract:
    ...
    return Contract(
        ...
        interfaces={
            "requirement": "PK_ACCEL_REQ/1 - class, mem_gb, count, interconnect, isolation, tenant",
            "inventory": "PK_ACCEL_INVENTORY/1 - device id, class, mem_gb, node, link group, partition parent, tenant ownership",
            "match": "PK_ACCEL_MATCH/1 - selected device ids or explained refusal"
        },
        threats=[
