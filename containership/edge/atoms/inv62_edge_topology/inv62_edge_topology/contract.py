...
Edge topology is the shape of the estate: cloud regions, sites, and devices at the far end,
connected by links of very different latency and reliability. This element keeps that graph, answers
'what is nearest that can serve this?', and keeps a site working when its uplink goes -- a
partitioned site elects a local coordinator instead of stopping.
"""
