# G12-I115 — Exception/waiver/technical-debt register (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** signed, expiring waivers only.
...
- **Unsupported:** an approver registry (empty) — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
