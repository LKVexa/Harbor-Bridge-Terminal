# G12-I103 — Pinned external dependency versions (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** stdlib-only runtime; the one optional dependency pinned exactly.
...
- **Unsupported:** hash-pinned lock file — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
