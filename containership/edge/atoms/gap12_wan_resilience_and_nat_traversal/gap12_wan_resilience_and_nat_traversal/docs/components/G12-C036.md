# G12-C036 — Candidate cache with safe expiry (P1)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** cached candidates only for the same network fingerprint and TTL.
...
- `max_entries` (validated at construction; see module docstring for units/ranges)
