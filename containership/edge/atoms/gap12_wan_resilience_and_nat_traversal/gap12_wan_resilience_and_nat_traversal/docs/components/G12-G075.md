# G12-G075 — Metrics exporter (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** catalogued metrics within cardinality budget.
...
- **Unsupported:** a push/scrape agent — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
...
- `cardinality_budget` (validated at construction; see module docstring for units/ranges)
