# G12-C042 — Predictive path switching (P2)

_Generated from `evidence/registry.py`; lifecycle **implementation**._

## Normative requirement
- **Success:** a pre-emptive switch recommendation only on a sustained trend.
...
## Interfaces
- `wan.quality.TrendPredictor`

## Dependencies and trust boundaries
- none declared

## Configurable parameters
- `alpha` (validated at construction; see module docstring for units/ranges)
- `min_points` (validated at construction; see module docstring for units/ranges)
