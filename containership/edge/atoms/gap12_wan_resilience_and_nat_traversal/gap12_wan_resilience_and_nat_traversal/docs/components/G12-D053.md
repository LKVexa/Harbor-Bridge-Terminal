# G12-D053 — Endpoint privacy controls (P1)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** endpoints pseudonymised and secrets removed in all text sinks.
...
## Interfaces
- `wan.security.redact`
- `wan.security.endpoint_token`

## Dependencies and trust boundaries
- none declared

## Configurable parameters
- `salt` (validated at construction; see module docstring for units/ranges)
