# G12-E065 — Stale-controller/duplicate-owner protection (P1)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** stale controllers' tokens refused.
...
- **Unsupported:** a distributed lease store — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
- **Policy rejection:** `POLICY_*` reason codes (egress, mechanism disabled, quarantine, untrusted peer, config rejected).

## Interfaces
- `wan.state.FencedLease`
