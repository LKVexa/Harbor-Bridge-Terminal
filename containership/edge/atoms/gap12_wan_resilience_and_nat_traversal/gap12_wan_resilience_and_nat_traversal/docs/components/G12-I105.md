# G12-I105 — CI pipeline (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** lanes on one revision; skipped mandatory lanes fail the gate.
...
- **Unsupported:** a hosted CI service — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
