# G12-I114 — Compatibility matrix and end-of-life policy (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** contract compatibility table and proposed EOL.
...
- **Unsupported:** an approved EOL policy — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
- **Policy rejection:** `POLICY_*` reason codes (egress, mechanism disabled, quarantine, untrusted peer, config rejected).

## Interfaces
- `docs.COMPATIBILITY_EOL`
