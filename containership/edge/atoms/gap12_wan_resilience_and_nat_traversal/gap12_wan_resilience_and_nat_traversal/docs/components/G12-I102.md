# G12-I102 — Reproducible package metadata/build (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** two builds byte-identical.
...
- `SOURCE_DATE_EPOCH` (validated at construction; see module docstring for units/ranges)
