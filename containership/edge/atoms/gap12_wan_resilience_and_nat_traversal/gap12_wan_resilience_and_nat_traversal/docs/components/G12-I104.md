# G12-I104 — SBOM and provenance/signature generation (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** SBOM + provenance bound to the artifact digest.
...
- **Unsupported:** signing (no identity/key) — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
