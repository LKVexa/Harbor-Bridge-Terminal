# G12-E058 — Durable or reconstructable path/session state policy (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** atomic, digest-verified snapshots; restored paths revalidate.
...
## Interfaces
- `wan.state.PathStore.save`
- `wan.state.PathStore.restore`
