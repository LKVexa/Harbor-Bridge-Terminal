# G12-I112 — Incident severity/paging/escalation matrix (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** severity/paging/escalation by role.
...
- **Unsupported:** paging integrations and named people — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
- **Policy rejection:** `POLICY_*` reason codes (egress, mechanism disabled, quarantine, untrusted peer, config rejected).

## Interfaces
- `docs.INCIDENT_MATRIX`
