# G12-B022 — Source-address/interface pinning (P1)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** a socket whose source address is the requested one or an error.
...
## Interfaces
- `wan.netenv.pinned_socket`
- `wan.netenv.verify_pinning`
...
- OSError = source address not local; never silently unpinned
