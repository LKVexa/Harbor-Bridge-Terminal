"""Conformance test for GAP-12 (gap12_wan_resilience_and_nat_traversal) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python gap12_wan_resilience_and_nat_traversal/tests/test_component.py
