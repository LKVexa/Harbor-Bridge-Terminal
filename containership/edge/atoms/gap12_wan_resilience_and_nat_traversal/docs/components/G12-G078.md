# G12-G078 — Health/readiness endpoint (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** /livez, /readyz with blocking deps, /metrics.
...
## Interfaces
- `wan.obs.HealthServer`
- `wan.obs.readiness_from`

## Dependencies and trust boundaries
- dependency health

## Configurable parameters
- `bind` (validated at construction; see module docstring for units/ranges)
