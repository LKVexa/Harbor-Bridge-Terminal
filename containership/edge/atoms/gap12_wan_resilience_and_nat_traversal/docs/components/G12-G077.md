# G12-G077 — Distributed trace propagation (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** W3C traceparent spans; untrusted ids linked not adopted.
...
- **Unsupported:** exporting spans (OTLP) — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
...
- `sample_rate` (validated at construction; see module docstring for units/ranges)
