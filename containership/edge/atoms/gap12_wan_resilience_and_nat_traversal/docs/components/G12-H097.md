# G12-H097 — Long-duration soak tests (P1)

_Generated from `evidence/registry.py`; lifecycle **design**._

## Normative requirement
- **Success:** multi-hour soak.
...
- **Unsupported:** no long-duration run was performed — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
