# G12-I106 — Vulnerability scanning and patch SLA (P0)

_Generated from `evidence/registry.py`; lifecycle **design**._

## Normative requirement
- **Success:** vulnerability scanning and patch SLA.
...
- **Unsupported:** no scanner reachable offline; SLA needs owner commitment — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
