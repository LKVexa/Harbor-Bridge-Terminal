# G12-G080 — Operator explain view (P1)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** a decision trail with reasons and pseudonymised peer.
