# G12-H093 — Firewall/UDP-blocked/captive-portal test scenarios (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** firewall, UDP-blocked and captive scenarios.
...
- **Unsupported:** captive portal only at HTTP level (no lab portal) — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
