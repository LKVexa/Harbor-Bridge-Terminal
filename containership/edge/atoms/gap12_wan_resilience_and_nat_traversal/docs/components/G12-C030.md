# G12-C030 — Bulk-transfer readiness probe (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** readiness decided from sustained goodput, not liveness.
...
- `min_bytes_per_s` (validated at construction; see module docstring for units/ranges)
