# G12-H087 — Integration tests against real STUN/TURN implementations (P0)

_Generated from `evidence/registry.py`; lifecycle **design**._

## Normative requirement
- **Success:** interop with independent STUN/TURN implementations.
...
- **Unsupported:** no independent implementation (coturn etc.) is installable here: PyPI/apt blocked — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
