# G12-E056 — Thread/async safety model (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** no torn reads under concurrent mutation.
...
- `max_peers` (validated at construction; see module docstring for units/ranges)
