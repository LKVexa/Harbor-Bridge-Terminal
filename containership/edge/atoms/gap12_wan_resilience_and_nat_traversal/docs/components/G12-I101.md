# G12-I101 — Declared supported Python/runtime/platform matrix (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** a declared matrix; verified cells executed in CI.
...
- **Unsupported:** Windows/macOS and Python 3.10/3.12/3.13 cells are declared, not executed — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
