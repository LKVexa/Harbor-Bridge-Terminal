# G12-I107 — Canary/staged rollout/rollback mechanism (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** canary stages with evidence holds and auto-rollback.
...
- **Unsupported:** fleet deployment tooling — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
...
- `soak_s` (validated at construction; see module docstring for units/ranges)
- `criteria` (validated at construction; see module docstring for units/ranges)
