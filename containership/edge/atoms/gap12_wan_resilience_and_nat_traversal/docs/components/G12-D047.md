# G12-D047 — TURN credential lifecycle and rotation (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** time-limited credentials verified across a rotation overlap, revocable.
...
## Interfaces
- `wan.security.TurnRestCredentials`
