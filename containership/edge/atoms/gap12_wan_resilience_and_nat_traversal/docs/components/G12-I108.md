# G12-I108 — Emergency-disable/kill switch (P0)

_Generated from `evidence/registry.py`; lifecycle **validation**._

## Normative requirement
- **Success:** signed, scoped, versioned, expiring, audited disables with a safe default.
...
- **Unsupported:** control-plane distribution — reported as `UNSUPPORTED` / NOT-EVIDENCED, never emulated.
- **Policy rejection:** `POLICY_*` reason codes (egress, mechanism disabled, quarantine, untrusted peer, config rejected).

## Interfaces
- `wan.rollout.KillSwitch`
