"""Conformance test for INV-10 (inv10_component_composition_system) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv10_component_composition_system/tests/test_component.py
