...
def build() -> Contract:
    ...
    return Contract(
        ...
        boundaries={
            "tenant": "one guest, one tenant; concrete device instances may not be shared by distinct live guests",
        ...
        interfaces={
            ...
            "stop": "PK_FULL_VM_STATE/1 - stop result after device-lease release",
            "destroy": "PK_FULL_VM_STATE/1 - terminal destruction result; repeat destroy is idempotent",
            "error": "PK_FULL_VM_ERROR/1 - machine-readable operational failure code and message"
        },
        threats=[
            "A hostile guest OS attacking the VMM",
            "Software emulation offered as an equivalent when hardware is absent",
            "Device-instance sharing between distinct live guests",
        ...
        slos=[
            ...
            Slo("guest device exclusivity", "zero concrete device instances shared between distinct live guests", "no budget"),
