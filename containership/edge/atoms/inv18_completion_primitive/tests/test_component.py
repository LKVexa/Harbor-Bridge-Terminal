"""Conformance test for INV-18 (inv18_completion_primitive) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv18_completion_primitive/tests/test_component.py
...
class ConformanceTest(unittest.TestCase):
    """REQ: C031 C100 — pk_core audit integration.  Mandatory: a skip here is BLOCKED at the gate."""
