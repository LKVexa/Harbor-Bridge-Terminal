"""Conformance test for GAP-08 -- stdlib unittest, no network.

Core rollout tests run without pk_core in ``test_rollout.py``.  Framework-level
checks in this file run when pk_core is available.
"""
