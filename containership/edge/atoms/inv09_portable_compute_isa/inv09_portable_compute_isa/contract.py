...
def build() -> Contract:
    ...
    return Contract(
        ...
        source_of_truth="Validated byte-level module facts plus the selected profile; used-but-undeclared features and declared or used capabilities outside the profile fail closed.",
        assumptions=[
