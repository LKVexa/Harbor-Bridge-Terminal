"""Conformance test for INV-67 (inv67_kubernetes_integration_mechanism) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv67_kubernetes_integration_mechanism/tests/test_component.py
