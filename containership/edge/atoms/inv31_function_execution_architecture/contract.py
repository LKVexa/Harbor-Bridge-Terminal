...
def build() -> Contract:
    ...
    return Contract(
        ...
        dependencies=[
            Dependency("pk_core", "upstream", "Provides the checklist, contract and component conformance framework"),
        ...
        assumptions=[
            ...
            "Invocation time is supplied as a non-negative integer tick; clock rollback is treated as unsafe for warm reuse"
        ],
        boundaries={
        ...
        interfaces={
            "invoke": "PK_INVOCATION/1 - run one invocation, cold or warm; schema: schemas/PK_INVOCATION_1.schema.json",
            "pool": "PK_FUNCTION_POOL/1 - bounded pool diagnostics; schema: schemas/PK_FUNCTION_POOL_1.schema.json"
        },
        threats=[
            ...
            "Resource exhaustion through unbounded instance creation or oversized identifiers",
            "Clock rollback causing unsafe reuse of instances created in the apparent future"
        ],
        failure_modes=[
            ...
            "Pool safety ceiling reached while all instances are busy",
            "Clock rollback invalidates instance age"
        ],
        slos=[
        ...
        signals={
            ...
            "instance_age_ticks": "histogram at eviction using the caller-supplied logical clock",
            ...
            "pool_capacity_rejections": "counter of invocations refused because every bounded pool slot is busy",
            "clock_rollback_evictions": "counter of idle instances removed after a negative-age observation"
        },
    )
