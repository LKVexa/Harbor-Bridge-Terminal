"""Secret-material detection and centralized redaction (INV-26 C039, C075).

Carried verbatim into INV-26 from the owner's INV-68 v4.3.0 ``redaction.py``; INV-68 notes follow.
