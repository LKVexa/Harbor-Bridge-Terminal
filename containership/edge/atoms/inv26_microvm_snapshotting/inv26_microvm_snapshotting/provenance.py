"""Release provenance producer (INV-26 C045, X004; carried from INV-68 MC-09/MC-32) — carried from the owner's INV-64 4.3.0 ``provenance.py`` (originally INV-44 v4.3.0).
...
def statement(subject: list[dict], *, version: str, builder_id: str, invocation: dict,
              dependencies: list[dict], build_type: str = "urn:pk:inv26:local-build:1") -> dict:
    return {
