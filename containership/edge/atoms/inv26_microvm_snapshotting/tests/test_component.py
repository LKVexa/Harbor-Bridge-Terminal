"""Conformance test for INV-26 (inv26_microvm_snapshotting) -- stdlib unittest, no network.

Run from the folder that contains this package (and ``pk_core``), e.g.::

    python inv26_microvm_snapshotting/tests/test_component.py
...
class ConformanceTest(unittest.TestCase):
    def test_version(self):
        ...
        self.assertEqual((PKG_DIR / "VERSION").read_text().strip(), "6.0.0")
