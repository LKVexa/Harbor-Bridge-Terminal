"""Dependency drift check + SBOM generation (C031, C093).
    ...
    python -m inv69_agentic_workload_layer.tools.deps_check [--sbom evidence/SBOM.json]
...
def sbom() -> dict:
    ...
    return {"bomFormat": "CycloneDX", "specVersion": "1.5",
            "metadata": {"component": {"type": "library", "name": "inv69_agentic_workload_layer",
                                       "version": (ROOT / "VERSION").read_text().strip()},
                         "tools": [{"name": "tools/deps_check.py"}]},
            "components": deps + comps,
            "dependencies": [{"ref": "inv69_agentic_workload_layer", "dependsOn": []}],
