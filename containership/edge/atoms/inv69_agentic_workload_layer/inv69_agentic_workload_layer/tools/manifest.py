...
(which records the SHA256SUMS digest).  RELEASE_MANIFEST.json then pins all three.
    python -m inv69_agentic_workload_layer.tools.manifest [--verify]
"""
...
def main(argv=None) -> int:
    ...
    manifest = {
        "component": "INV-69 Agentic workload layer", "version": (ROOT / "VERSION").read_text().strip(),
        "release_date": "2026-09-23",
        "source_archive": {"name": "inv69_agentic_workload_layer_v4.2.0_hardened.zip",
                           "sha256": "934ba558e8280a97d06eb4471326354f9032f039ecda5504bc161269f44ff716"},
        "applied_package": {"name": "INV69_v4.2.0_MISSING_COMPONENTS_IMPLEMENTATION_CHECKLIST.md",
                            "sha256": "1e3584c696b65e22b224ec46af2c412eaa9d48bc9fad400ced06be70b902ee2d"},
