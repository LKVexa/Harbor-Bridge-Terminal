...
def build() -> Contract:
    ...
    return Contract(
        ...
        interfaces={
            "step": "PK_AGENT_STEP/1 - one tool call and its outcome; schema: schemas/PK_AGENT_STEP-1.schema.json",
            "approval": "PK_AGENT_APPROVAL/1 - a recorded human or policy approval; schema: schemas/PK_AGENT_APPROVAL-1.schema.json",
            "transcript": "PK_AGENT_TRANSCRIPT/1 - ordered steps; schema: schemas/PK_AGENT_TRANSCRIPT-1.schema.json"
        },
        threats=[
