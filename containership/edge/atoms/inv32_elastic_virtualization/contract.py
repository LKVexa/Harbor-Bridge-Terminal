...
def build() -> Contract:
    ...
    return Contract(
        ...
        owns=[
            ...
            "Hash-chained local audit evidence for resource mutations"
        ],
        not_owns=[
            "Capacity targets",
            "Placement",
        ...
        boundaries={
            ...
            "environment": "reserve fractions may differ per environment but are validated before host activation",
        ...
        interfaces={
            "adjust": "PK_RESOURCE_ADJUSTMENT/2 - replay-safe memory/vCPU adjustment and validated rollback",
            "host": "PK_HOST_RESOURCES/1 - total, reserved, allocated, free and audit head",
            "audit": "PK_RESOURCE_AUDIT/1 - hash-chained local mutation evidence"
        },
        threats=[
            ...
            "Forged or stale rollback records overwriting newer allocation state",
            "Duplicate operation replay causing repeated mutation"
        ],
        failure_modes=[
            ...
            "Stale or forged adjustment record",
            "Tampered local audit history"
        ],
        slos=[
            ...
            Slo("reversibility", "100% of non-stale applied adjustments reversible to the previous value", "no budget"),
            Slo("audit-integrity", "zero accepted mutations after local audit-chain corruption", "no budget")
        ],
        signals={
            ...
            "audit_head": "current hash-chain head for local resource mutation history",
            "free_page_reports": "bounded guest-reported reclaimable memory"
        },
    )
