...
`DF_Fabric`: pre-seal 14/16 (2 skipped: the two hash gates, by construction) · post-seal `./VERIFY` **16/16** on the assembly host -- replica, pipeline
...
| zip | bytes | sha256 |
|---|---|---|
| `DF_Small.zip` | 615735 | `d64085ac90f44b24196b0d0ed1b2859bb974723f8644a7258d1347550b9a5e07` |
| `DF_Medium.zip` | 1211714 | `7c57c6ce49f7ff4c492cc53c3177778d04adfa96f3a96525c57c3c9f4ef2cda4` |
| `DF_Large.zip` | 2067527 | `7acac542729a118c58e02ad85918391a02d50f09aec04a1c07a9aa2e401e1ab9` |
| `DF_Xtra_Large.zip` | 9573100 | `c0432c148083baf01cc8dbf159a5f742cf1f9b9d4780f89db5a0a8870fec9a83` |
| `DF_Fabric.zip` | 608267 | `68190339251b5faa98d16f010b400b97e182cd825e7ee29a5985cc662400c718` |

`DF_SHA256SUMS.txt` binds them; `DF_ASSEMBLY_RECORD.json` and `_assembly/` hold the assembly and post-seal verification records.
