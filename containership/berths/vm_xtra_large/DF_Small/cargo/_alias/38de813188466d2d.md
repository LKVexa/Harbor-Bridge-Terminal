...
19. **Evidence receipt.** Emit `vm/world/evidence/remediation_315/RCPW-17-R20.json` conforming to `00_COMMON_EVIDENCE_CONTRACT.md`, including exact commands, exit codes, observed values, digests, profile, hashes, and blocker field.
